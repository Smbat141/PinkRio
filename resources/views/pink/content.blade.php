            ...
            @foreach($portfolios as $index=>$value)
                ...
                <div class="hentry work group portfolio-sticky portfolio-full-description">
                    <div class="work-thumbnail">
                        <a class="thumb"><img src="{{asset(env('THEME'))}}/images/projects/{{$value->img->mini}}" alt="0081" title="0081" /></a>
                            ...
                            <div class="related_project{{($index == 4)?'_last related_project' : ''}}">
                                <div class="overlay_a related_img">
                                    <div class="overlay_wrapper">
                                        ...
                                        <div class="overlay">
                                            <a class="overlay_img" href="{{asset(env('THEME'))}}/images/projects/{{$value->img->max}}" rel="lightbox" title=""></a>
